/************************************************************* 
* countButton -- a simple program to demonstrate the use of  *
*                AVR interrupts and volatile variables       *
*                                                            * 
...
*          pressed. Count the number of times the button is  *
*          pressed                                           *
*                                                            * 
...
int main(void){
    ...
    initUSART(); /* Start serial connections */
